...
const DarkModeIcon = () => {
  return (
    ...
    >
      <path
        d='M9.37 5.51001C9.19 6.15001 9.1 6.82001 9.1 7.50001C9.1 11.58 12.42 14.9 16.5 14.9C17.18 14.9 17.85 14.81 18.49 14.63C17.45 17.19 14.93 19 12 19C8.14 19 5 15.86 5 12C5 9.07001 6.81 6.55001 9.37 5.51001Z'
        fill='#E1E1E1'
      />
      <path
